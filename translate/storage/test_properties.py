...
"key" = "value";'''.encode('utf-16')
    ...
    def test_mozilla_parsing(self):
        # Use Mozilla's test file from:
        # http://mxr.mozilla.org/mozilla-central/source/xpcom/tests/unit/data/bug121341.properties?raw=1
        # and expeted results from:
        # http://mxr.mozilla.org/mozilla-central/source/xpcom/tests/unit/test_bug121341.js
        # We skip 3 since it is not valid Unicode
        propsource = u"""# simple check
1=abc
